    ...
    <div className="flex items-center gap-8 pr-8">
      {Array(6).fill(null).map((_, idx) => (
        <React.Fragment key={idx}>
          ...
          <span className={`${starColor} text-label-sm`}>✦</span>
          ...
          <span className={`${starColor} text-label-sm`}>✦</span>
          <span className={`${textColor} font-arabic font-bold text-title-md tracking-[0.1em] normal-case`}>المطبخ العربي</span>
          <span className={`${starColor} text-label-sm`}>✦</span>
  ...
  return (
    <section className="relative bg-[#1A0A00] py-10 md:py-14 overflow-hidden select-none border-y border-[#C9952A]/30 z-10 flex flex-col gap-6 md:gap-8">
      ...
      <div className="flex w-full overflow-hidden relative cursor-pointer">
        <div className="flex animate-[marquee-left_60s_linear_infinite] hover:[animation-play-state:paused] whitespace-nowrap text-body-lg uppercase">
      ...
      <div className="flex w-full overflow-hidden relative cursor-pointer">
        <div className="flex animate-[marquee-right_60s_linear_infinite] hover:[animation-play-state:paused] whitespace-nowrap text-body-lg uppercase">
