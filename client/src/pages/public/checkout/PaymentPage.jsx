...
import { getCart, clearCart, addOrder, parsePrice } from '../../../utils/orderStorage';
...
export default function PaymentPage() {
  ...
  const handleCompleteOrder = (e) => {
    ...
    sessionStorage.setItem('arabic_kitchen_last_order_id', saved.id);

    // Redirect to confirmation page after short delay
    setTimeout(() => {
      window.location.hash = `#confirmation?id=${saved.id}`;
    }, 1000);
  };
