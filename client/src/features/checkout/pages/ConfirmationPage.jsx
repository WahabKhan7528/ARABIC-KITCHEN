...
export default function ConfirmationPage() {
  ...
  useEffect(() => {
    ...
    // Listen to cross-tab changes (e.g. from Dashboard in another tab/window)
    const handleStorageChange = (e) => {
      // ORDERS_KEY is 'arabic_kitchen_orders_v2'
      if (e.key === 'arabic_kitchen_orders_v2') {
        fetchOrder();
      }
    };
    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="border-2 border-gold/25 p-8 bg-[#1F1108]/90 shadow-[0_20px_50px_rgba(0,0,0,0.85)] relative overflow-hidden rounded-[2px] mb-8 text-center">
          ...
          <p className="text-label-xs text-cream/50 uppercase tracking-widest font-mono">Order ID: {order._id}</p>
